    ...
    public static void playMusic(String caminho) {
        try { // Bloco try para envolver o código que pode potencialmente lançar uma excepção
            ...
            if (audio.exists()) { // Se encontrar o ficheiro
                ...
                clip.loop(Clip.LOOP_CONTINUOUSLY);// Configura o áudio para tocar em loop contínuo
            ...
            System.out.println(Tools.ConsoleColors.RED + "Erro ao play audio" + Tools.ConsoleColors.RESET);
        }
    }
}
