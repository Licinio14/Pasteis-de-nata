...
public class CriacaoArremesaveis {
    ...
    public static Arremesavel granada = new Arremesavel("Granada",80,TipoConsumivel.DANOINSTANTANEO,TipoHeroi.MILITAR,100,"Uma granada que o vendedor consegui roubar de uma base militar, da 100 de dano");
